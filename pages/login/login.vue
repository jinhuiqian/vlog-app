<template>
	<view>
		...
		<view class="px-2">
			<view class="mb-2"><input type="text" placeholder="昵称/手机号/邮箱" class="border-bottom p-2"
			/></view>
		...
		<view class="py-2 px-3">
			<button class="bg-main text-white" style="border-radius: 50rpx;border: 0;" type="primary">登录
			</button>
		</view>
		
		<view class="flex align-center justify-center pt-2 pb-4">
			<view class="text-primary font-sm">验证码登录</view>
		...
		<view class="flex align-center justify-center">
			...
			<view class="mx-2 text-muted">社交帐号登录</view>
			<view style="height: 1rpx;background-color: #dddddd;width: 100rpx;"></view>
		</view>
	</view>
</template>
